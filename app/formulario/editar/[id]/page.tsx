            ...
            try {
                ...
                const mappedData = {
                    ...
                    predio: {
                        ...
                        latitud: serverData.predio?.latitud != null ? Number(serverData.predio.latitud) : 7.1254,
                        longitud: serverData.predio?.longitud != null ? Number(serverData.predio.longitud) : -73.1198,
                    ...
                    caracterizacion: {
                        ...
                        distanciaKm: serverData.caracterizacionPredio?.distancia_km != null ? Number(serverData.caracterizacionPredio.distancia_km) : null,
                        tiempoAcceso: serverData.caracterizacionPredio?.tiempo_acceso || "",
                        temperaturaCelsius: serverData.caracterizacionPredio?.temperatura_celsius != null ? Number(serverData.caracterizacionPredio.temperatura_celsius) : null,
                    ...
                    areaProductiva: {
                        ...
                        ingresoMensualVentas: serverData.areaProductiva?.ingreso_mensual_ventas != null ? Number(serverData.areaProductiva.ingreso_mensual_ventas) : null,
                        sistemaProductivoInteres: serverData.areaProductiva?.sistema_productivo_interes || "",
                        hectareasSiembraNueva: serverData.areaProductiva?.hectareas_siembra_nueva != null ? Number(serverData.areaProductiva.hectareas_siembra_nueva) : null,
                        hectareasRenovacion: serverData.areaProductiva?.hectareas_renovacion != null ? Number(serverData.areaProductiva.hectareas_renovacion) : null,
                    },
                    infoFinanciera: {
                        ingresosMensualesAgropecuaria: serverData.infoFinanciera?.ingresos_mensuales_agropecuaria != null ? Number(serverData.infoFinanciera.ingresos_mensuales_agropecuaria) : null,
                        ingresosMensualesOtros: serverData.infoFinanciera?.ingresos_mensuales_otros != null ? Number(serverData.infoFinanciera.ingresos_mensuales_otros) : null,
                        egresosMensuales: serverData.infoFinanciera?.egresos_mensuales != null ? Number(serverData.infoFinanciera.egresos_mensuales) : null,
                        activosTotales: serverData.infoFinanciera?.activos_totales != null ? Number(serverData.infoFinanciera.activos_totales) : null,
                        activosAgropecuaria: serverData.infoFinanciera?.activos_agropecuaria != null ? Number(serverData.infoFinanciera.activos_agropecuaria) : null,
                        pasivosTotales: serverData.infoFinanciera?.pasivos_totales != null ? Number(serverData.infoFinanciera.pasivos_totales) : null,
                    },
                    archivos: {
                    ...
                    autorizaciones: {
                        ...
                        autorizacionConsultaCrediticia: serverData.caracterizacion?.autorizacion_consulta_crediticia ?? true,
                        autorizacionAvisoPrivacidad: serverData.caracterizacion?.autorizacion_aviso_privacidad ?? true,
