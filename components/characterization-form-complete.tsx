    ...
    try {
      ...
      const dataToSave = {
        ...
        predio: {
          ...
          areaTotal: formData.predio.areaTotalHectareas,
          areaCultivada: formData.predio.areaProductivaHectareas,
          latitud: formData.predio.latitud,
          longitud: formData.predio.longitud,
          altitud: formData.predio.altitudMsnm,
          direccion: formData.predio.direccion,
          codigoCatastral: formData.predio.codigoCatastral,
          fuenteAgua: '',
          accesoVial: formData.caracterizacion.rutaAcceso,
          distanciaCabecera: formData.caracterizacion.distanciaKm,
        ...
        caracterizacion: {
          ...
          drenaje: '',
          coberturaVegetal: [
            formData.caracterizacion.coberturaBosque && 'Bosque',
            formData.caracterizacion.coberturaCultivos && 'Cultivos',
            formData.caracterizacion.coberturaPastos && 'Pastos',
            formData.caracterizacion.coberturaRastrojo && 'Rastrojo',
          ].filter(Boolean).join(', '),
          rutaAcceso: formData.caracterizacion.rutaAcceso,
          distanciaKm: formData.caracterizacion.distanciaKm,
          tiempoAcceso: formData.caracterizacion.tiempoAcceso,
          temperaturaCelsius: formData.caracterizacion.temperaturaCelsius,
        ...
        areaProductiva: {
          cultivoPrincipal: formData.areaProductiva.sistemaProductivo,
          areaCultivoPrincipal: formData.predio.areaProductivaHectareas,
          produccionEstimada: parseFloat(formData.areaProductiva.cantidadProduccion) || 0,
          destinoProduccion: formData.areaProductiva.dondeComercializa,
          sistemaProduccion: formData.areaProductiva.sistemaProductivo,
