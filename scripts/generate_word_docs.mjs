...
async function doc01() {
  await guardar([
    ...
    P("El sistema fue construido sobre Next.js 16, React 19, TypeScript y Supabase (PostgreSQL + Auth + Storage), desplegado en Vercel con funciones serverless. Incluye formulario de 9 pasos, generación de PDF, notificaciones por correo, captcha, firmas digitales y exportación CSV."),
...
async function doc04() {
  const casos = [
    { id:"CU01", nombre:"Registrar Caracterización", actor:"Asesor / Público", sistema:"Sistema Agro360",
      ...
      flujo:["1. Actor abre /formulario.","2. Completa 9 pasos.","3. Envía en paso 9.","4. Sistema valida captcha (si público).","5. Sistema inserta datos en BD.","6. Sistema genera radicado RAD-000XXX.","7. Sistema envía correo al beneficiario.","8. Muestra pantalla de confirmación."],
...
async function doc13() {
  await guardar([
    ...
    ...["NEXT_PUBLIC_SUPABASE_URL","NEXT_PUBLIC_SUPABASE_ANON_KEY","SUPABASE_SERVICE_ROLE_KEY",
       "DATABASE_URL","NEXT_PUBLIC_APP_URL","SMTP_HOST","SMTP_USER","SMTP_PASS","SMTP_FROM",
       "NEXT_PUBLIC_TURNSTILE_SITE_KEY","TURNSTILE_SECRET_KEY"].map(LI),
...
async function doc18() {
  await guardar([
    ...
    TABLA(["ID","Módulo","Descripción","Pasos","Resultado esperado","Estado"], [
      ...
      ["PT002","Formulario","Envío público con captcha","1.Sin login, abrir /formulario 2.Completar 3.Resolver captcha 4.Enviar","Radicado generado, asesor_id=null","Pass"],
...
async function doc23() {
  await guardar([
    ...
    LI("3. Si es público: validar captcha Turnstile."),
...
async function doc25() {
  await guardar([
    ...
    LI("TURNSTILE_SECRET_KEY: solo en servidor. Validación de captcha."),
...
async function doc33() {
  await guardar([
    ...
    P("☐  Captcha Turnstile activo y verificado."),
